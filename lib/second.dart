...
import 'package:timerapp/third.dart';
  ...
  _timer = Timer.periodic(
    ...
    (Timer timer) {
      if (_start == 0) {
          timer.cancel();
          _isTimerOn = false;
          // Navigate to the next page when the timer reaches 0.
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => Timerthree()),
          );
        } else if (_start == 5) {
        playAlert();
        setState(() {
             ...
             Row(children: [
              ...
              SizedBox(height:2,),
               Text(
                      ...
                      Text(
                        "You have 10 minitues to eat before the pause.",
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 18,
